...
namespace RestoRepo.Data
{
    public class RestoDbInitializer : DropCreateDatabaseIfModelChanges<RestoContext> // DropCreateDatabaseAlways
    {
        ...
        IList<Order> GetInitialOrders()
        {
            ...
            orders.Add(new Order() { Date= DateTime.Today, State= orderState.open.ToString(),
            ...
            orders.Add(new Order() { Date= DateTime.Today, State= orderState.inProgress.ToString(),
            ...
            orders.Add(new Order() { Date= DateTime.Today, State= orderState.ready.ToString(),
